...
namespace Protocol {
class A_ObjectWeaponChange;
struct A_ObjectWeaponChangeDefaultTypeInternal;
extern A_ObjectWeaponChangeDefaultTypeInternal _A_ObjectWeaponChange_default_instance_;
class C_Attack;
struct C_AttackDefaultTypeInternal;
extern C_AttackDefaultTypeInternal _C_Attack_default_instance_;
class C_Attack_Arrow;
struct C_Attack_ArrowDefaultTypeInternal;
extern C_Attack_ArrowDefaultTypeInternal _C_Attack_Arrow_default_instance_;
class C_Move;
...
class S_Attack_Arrow;
struct S_Attack_ArrowDefaultTypeInternal;
extern S_Attack_ArrowDefaultTypeInternal _S_Attack_Arrow_default_instance_;
class S_EnterGame;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::Protocol::A_ObjectWeaponChange* Arena::CreateMaybeMessage<::Protocol::A_ObjectWeaponChange>(Arena*);
template<> ::Protocol::C_Attack* Arena::CreateMaybeMessage<::Protocol::C_Attack>(Arena*);
template<> ::Protocol::C_Attack_Arrow* Arena::CreateMaybeMessage<::Protocol::C_Attack_Arrow>(Arena*);
...
template<> ::Protocol::S_Attack_Arrow* Arena::CreateMaybeMessage<::Protocol::S_Attack_Arrow>(Arena*);
...
class C_Attack_Arrow final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Protocol.C_Attack_Arrow) */ {
 public:
  inline C_Attack_Arrow() : C_Attack_Arrow(nullptr) {}
  ~C_Attack_Arrow() override;
  explicit PROTOBUF_CONSTEXPR C_Attack_Arrow(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  C_Attack_Arrow(const C_Attack_Arrow& from);
  C_Attack_Arrow(C_Attack_Arrow&& from) noexcept
    : C_Attack_Arrow() {
    *this = ::std::move(from);
  }

  inline C_Attack_Arrow& operator=(const C_Attack_Arrow& from) {
    CopyFrom(from);
    return *this;
  }
  inline C_Attack_Arrow& operator=(C_Attack_Arrow&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const C_Attack_Arrow& default_instance() {
    return *internal_default_instance();
  }
  static inline const C_Attack_Arrow* internal_default_instance() {
    return reinterpret_cast<const C_Attack_Arrow*>(
               &_C_Attack_Arrow_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    10;

  friend void swap(C_Attack_Arrow& a, C_Attack_Arrow& b) {
    a.Swap(&b);
  }
  inline void Swap(C_Attack_Arrow* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(C_Attack_Arrow* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  C_Attack_Arrow* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<C_Attack_Arrow>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const C_Attack_Arrow& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const C_Attack_Arrow& from) {
    C_Attack_Arrow::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(C_Attack_Arrow* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "Protocol.C_Attack_Arrow";
  }
  protected:
  explicit C_Attack_Arrow(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // .Protocol.AttackArrowInfo info = 1;
  bool has_info() const;
  private:
  bool _internal_has_info() const;
  public:
  void clear_info();
  const ::Protocol::AttackArrowInfo& info() const;
  PROTOBUF_NODISCARD ::Protocol::AttackArrowInfo* release_info();
  ::Protocol::AttackArrowInfo* mutable_info();
  void set_allocated_info(::Protocol::AttackArrowInfo* info);
  private:
  const ::Protocol::AttackArrowInfo& _internal_info() const;
  ::Protocol::AttackArrowInfo* _internal_mutable_info();
  public:
  void unsafe_arena_set_allocated_info(
      ::Protocol::AttackArrowInfo* info);
  ::Protocol::AttackArrowInfo* unsafe_arena_release_info();

  // @@protoc_insertion_point(class_scope:Protocol.C_Attack_Arrow)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::Protocol::AttackArrowInfo* info_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_Protocol_2eproto;
...
class S_Attack_Arrow final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Protocol.S_Attack_Arrow) */ {
 public:
  inline S_Attack_Arrow() : S_Attack_Arrow(nullptr) {}
  ~S_Attack_Arrow() override;
  explicit PROTOBUF_CONSTEXPR S_Attack_Arrow(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  S_Attack_Arrow(const S_Attack_Arrow& from);
  S_Attack_Arrow(S_Attack_Arrow&& from) noexcept
    : S_Attack_Arrow() {
    *this = ::std::move(from);
  }

  inline S_Attack_Arrow& operator=(const S_Attack_Arrow& from) {
    CopyFrom(from);
    return *this;
  }
  inline S_Attack_Arrow& operator=(S_Attack_Arrow&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const S_Attack_Arrow& default_instance() {
    return *internal_default_instance();
  }
  static inline const S_Attack_Arrow* internal_default_instance() {
    return reinterpret_cast<const S_Attack_Arrow*>(
               &_S_Attack_Arrow_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    11;

  friend void swap(S_Attack_Arrow& a, S_Attack_Arrow& b) {
    a.Swap(&b);
  }
  inline void Swap(S_Attack_Arrow* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(S_Attack_Arrow* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  S_Attack_Arrow* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<S_Attack_Arrow>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const S_Attack_Arrow& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const S_Attack_Arrow& from) {
    S_Attack_Arrow::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(S_Attack_Arrow* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "Protocol.S_Attack_Arrow";
  }
  protected:
  explicit S_Attack_Arrow(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:Protocol.S_Attack_Arrow)
 private:
  class _Internal;
...
class A_ObjectWeaponChange final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Protocol.A_ObjectWeaponChange) */ {
 public:
  inline A_ObjectWeaponChange() : A_ObjectWeaponChange(nullptr) {}
  ~A_ObjectWeaponChange() override;
  explicit PROTOBUF_CONSTEXPR A_ObjectWeaponChange(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  A_ObjectWeaponChange(const A_ObjectWeaponChange& from);
  A_ObjectWeaponChange(A_ObjectWeaponChange&& from) noexcept
    : A_ObjectWeaponChange() {
    *this = ::std::move(from);
  }

  inline A_ObjectWeaponChange& operator=(const A_ObjectWeaponChange& from) {
    CopyFrom(from);
    return *this;
  }
  inline A_ObjectWeaponChange& operator=(A_ObjectWeaponChange&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const A_ObjectWeaponChange& default_instance() {
    return *internal_default_instance();
  }
  static inline const A_ObjectWeaponChange* internal_default_instance() {
    return reinterpret_cast<const A_ObjectWeaponChange*>(
               &_A_ObjectWeaponChange_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    12;

  friend void swap(A_ObjectWeaponChange& a, A_ObjectWeaponChange& b) {
    a.Swap(&b);
  }
  inline void Swap(A_ObjectWeaponChange* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(A_ObjectWeaponChange* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  A_ObjectWeaponChange* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<A_ObjectWeaponChange>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const A_ObjectWeaponChange& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const A_ObjectWeaponChange& from) {
    A_ObjectWeaponChange::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(A_ObjectWeaponChange* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "Protocol.A_ObjectWeaponChange";
  }
  protected:
  explicit A_ObjectWeaponChange(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // .Protocol.OBJECT_WEAPON_TYPE state = 2;
  void clear_state();
  ::Protocol::OBJECT_WEAPON_TYPE state() const;
  void set_state(::Protocol::OBJECT_WEAPON_TYPE value);
  private:
  ::Protocol::OBJECT_WEAPON_TYPE _internal_state() const;
  void _internal_set_state(::Protocol::OBJECT_WEAPON_TYPE value);
  public:

  // @@protoc_insertion_point(class_scope:Protocol.A_ObjectWeaponChange)
 private:
  class _Internal;
...
// repeated uint64 ids = 1;
inline int C_RemoveObject::_internal_ids_size() const {
  return _impl_.ids_.size();
}
inline int C_RemoveObject::ids_size() const {
  return _internal_ids_size();
}
inline void C_RemoveObject::clear_ids() {
  _impl_.ids_.Clear();
}
inline uint64_t C_RemoveObject::_internal_ids(int index) const {
  return _impl_.ids_.Get(index);
}
inline uint64_t C_RemoveObject::ids(int index) const {
  // @@protoc_insertion_point(field_get:Protocol.C_RemoveObject.ids)
  return _internal_ids(index);
}
inline void C_RemoveObject::set_ids(int index, uint64_t value) {
  _impl_.ids_.Set(index, value);
  // @@protoc_insertion_point(field_set:Protocol.C_RemoveObject.ids)
}
inline void C_RemoveObject::_internal_add_ids(uint64_t value) {
  _impl_.ids_.Add(value);
}
inline void C_RemoveObject::add_ids(uint64_t value) {
  _internal_add_ids(value);
  // @@protoc_insertion_point(field_add:Protocol.C_RemoveObject.ids)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint64_t >&
C_RemoveObject::_internal_ids() const {
  return _impl_.ids_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint64_t >&
C_RemoveObject::ids() const {
  // @@protoc_insertion_point(field_list:Protocol.C_RemoveObject.ids)
  return _internal_ids();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint64_t >*
C_RemoveObject::_internal_mutable_ids() {
  return &_impl_.ids_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint64_t >*
C_RemoveObject::mutable_ids() {
  // @@protoc_insertion_point(field_mutable_list:Protocol.C_RemoveObject.ids)
  return _internal_mutable_ids();
}
...
// .Protocol.AttackArrowInfo info = 1;
inline bool C_Attack_Arrow::_internal_has_info() const {
  return this != internal_default_instance() && _impl_.info_ != nullptr;
}
inline bool C_Attack_Arrow::has_info() const {
  return _internal_has_info();
}
inline const ::Protocol::AttackArrowInfo& C_Attack_Arrow::_internal_info() const {
  const ::Protocol::AttackArrowInfo* p = _impl_.info_;
  return p != nullptr ? *p : reinterpret_cast<const ::Protocol::AttackArrowInfo&>(
      ::Protocol::_AttackArrowInfo_default_instance_);
}
inline const ::Protocol::AttackArrowInfo& C_Attack_Arrow::info() const {
  // @@protoc_insertion_point(field_get:Protocol.C_Attack_Arrow.info)
  return _internal_info();
}
inline void C_Attack_Arrow::unsafe_arena_set_allocated_info(
    ::Protocol::AttackArrowInfo* info) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.info_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:Protocol.C_Attack_Arrow.info)
}
inline ::Protocol::AttackArrowInfo* C_Attack_Arrow::release_info() {
  
  ::Protocol::AttackArrowInfo* temp = _impl_.info_;
  _impl_.info_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::Protocol::AttackArrowInfo* C_Attack_Arrow::unsafe_arena_release_info() {
  // @@protoc_insertion_point(field_release:Protocol.C_Attack_Arrow.info)
  
  ::Protocol::AttackArrowInfo* temp = _impl_.info_;
  _impl_.info_ = nullptr;
  return temp;
}
inline ::Protocol::AttackArrowInfo* C_Attack_Arrow::_internal_mutable_info() {
  
  if (_impl_.info_ == nullptr) {
    auto* p = CreateMaybeMessage<::Protocol::AttackArrowInfo>(GetArenaForAllocation());
    _impl_.info_ = p;
  }
  return _impl_.info_;
}
inline ::Protocol::AttackArrowInfo* C_Attack_Arrow::mutable_info() {
  ::Protocol::AttackArrowInfo* _msg = _internal_mutable_info();
  // @@protoc_insertion_point(field_mutable:Protocol.C_Attack_Arrow.info)
  return _msg;
}
inline void C_Attack_Arrow::set_allocated_info(::Protocol::AttackArrowInfo* info) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.info_);
  }
  ...
  _impl_.info_ = info;
  // @@protoc_insertion_point(field_set_allocated:Protocol.C_Attack_Arrow.info)
}
...
// .Protocol.AttackArrowInfo info = 1;
inline bool S_Attack_Arrow::_internal_has_info() const {
  return this != internal_default_instance() && _impl_.info_ != nullptr;
}
inline bool S_Attack_Arrow::has_info() const {
  return _internal_has_info();
}
inline const ::Protocol::AttackArrowInfo& S_Attack_Arrow::_internal_info() const {
  const ::Protocol::AttackArrowInfo* p = _impl_.info_;
  return p != nullptr ? *p : reinterpret_cast<const ::Protocol::AttackArrowInfo&>(
      ::Protocol::_AttackArrowInfo_default_instance_);
}
inline const ::Protocol::AttackArrowInfo& S_Attack_Arrow::info() const {
  // @@protoc_insertion_point(field_get:Protocol.S_Attack_Arrow.info)
  return _internal_info();
}
inline void S_Attack_Arrow::unsafe_arena_set_allocated_info(
    ::Protocol::AttackArrowInfo* info) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.info_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:Protocol.S_Attack_Arrow.info)
}
inline ::Protocol::AttackArrowInfo* S_Attack_Arrow::release_info() {
...
inline ::Protocol::AttackArrowInfo* S_Attack_Arrow::unsafe_arena_release_info() {
  // @@protoc_insertion_point(field_release:Protocol.S_Attack_Arrow.info)
  
  ::Protocol::AttackArrowInfo* temp = _impl_.info_;
  _impl_.info_ = nullptr;
  return temp;
}
inline ::Protocol::AttackArrowInfo* S_Attack_Arrow::_internal_mutable_info() {
...
inline ::Protocol::AttackArrowInfo* S_Attack_Arrow::mutable_info() {
  ::Protocol::AttackArrowInfo* _msg = _internal_mutable_info();
  // @@protoc_insertion_point(field_mutable:Protocol.S_Attack_Arrow.info)
  return _msg;
}
inline void S_Attack_Arrow::set_allocated_info(::Protocol::AttackArrowInfo* info) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.info_);
  }
  ...
  _impl_.info_ = info;
  // @@protoc_insertion_point(field_set_allocated:Protocol.S_Attack_Arrow.info)
}
...
// uint64 objectId = 1;
inline void A_ObjectWeaponChange::clear_objectid() {
  _impl_.objectid_ = uint64_t{0u};
}
inline uint64_t A_ObjectWeaponChange::_internal_objectid() const {
  return _impl_.objectid_;
}
inline uint64_t A_ObjectWeaponChange::objectid() const {
  // @@protoc_insertion_point(field_get:Protocol.A_ObjectWeaponChange.objectId)
  return _internal_objectid();
}
inline void A_ObjectWeaponChange::_internal_set_objectid(uint64_t value) {
  
  _impl_.objectid_ = value;
}
inline void A_ObjectWeaponChange::set_objectid(uint64_t value) {
  _internal_set_objectid(value);
  // @@protoc_insertion_point(field_set:Protocol.A_ObjectWeaponChange.objectId)
}

// .Protocol.OBJECT_WEAPON_TYPE state = 2;
inline void A_ObjectWeaponChange::clear_state() {
  _impl_.state_ = 0;
}
inline ::Protocol::OBJECT_WEAPON_TYPE A_ObjectWeaponChange::_internal_state() const {
  return static_cast< ::Protocol::OBJECT_WEAPON_TYPE >(_impl_.state_);
}
inline ::Protocol::OBJECT_WEAPON_TYPE A_ObjectWeaponChange::state() const {
  // @@protoc_insertion_point(field_get:Protocol.A_ObjectWeaponChange.state)
  return _internal_state();
}
inline void A_ObjectWeaponChange::_internal_set_state(::Protocol::OBJECT_WEAPON_TYPE value) {
  
  _impl_.state_ = value;
}
inline void A_ObjectWeaponChange::set_state(::Protocol::OBJECT_WEAPON_TYPE value) {
  _internal_set_state(value);
  // @@protoc_insertion_point(field_set:Protocol.A_ObjectWeaponChange.state)
}
