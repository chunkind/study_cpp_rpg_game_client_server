...
PROTOBUF_CONSTEXPR AttackArrowInfo::AttackArrowInfo(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.objectid_)*/uint64_t{0u}
  , /*decltype(_impl_.targetid_)*/uint64_t{0u}
  , /*decltype(_impl_.damege_)*/0
...
struct AttackArrowInfoDefaultTypeInternal {
  PROTOBUF_CONSTEXPR AttackArrowInfoDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~AttackArrowInfoDefaultTypeInternal() {}
  union {
    AttackArrowInfo _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 AttackArrowInfoDefaultTypeInternal _AttackArrowInfo_default_instance_;
}  // namespace Protocol
...
const uint32_t TableStruct_Struct_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::AttackInfo, _impl_.objectid_),
  PROTOBUF_FIELD_OFFSET(::Protocol::AttackInfo, _impl_.targetid_),
  PROTOBUF_FIELD_OFFSET(::Protocol::AttackInfo, _impl_.damege_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::Protocol::AttackArrowInfo, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 26, -1, -1, sizeof(::Protocol::AttackInfo)},
  { 35, -1, -1, sizeof(::Protocol::AttackArrowInfo)},
};
...
static const ::_pb::Message* const file_default_instances[] = {
  ...
  &::Protocol::_AttackArrowInfo_default_instance_._instance,
};
...
void AttackInfo::InternalSwap(AttackInfo* other) {
  ...
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(AttackInfo, _impl_.damege_)
      + sizeof(AttackInfo::_impl_.damege_)
      - PROTOBUF_FIELD_OFFSET(AttackInfo, _impl_.objectid_)>(
          reinterpret_cast<char*>(&_impl_.objectid_),
          reinterpret_cast<char*>(&other->_impl_.objectid_));
}
...
class AttackArrowInfo::_Internal {
 public:
};

AttackArrowInfo::AttackArrowInfo(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:Protocol.AttackArrowInfo)
}
AttackArrowInfo::AttackArrowInfo(const AttackArrowInfo& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  AttackArrowInfo* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.objectid_){}
    , decltype(_impl_.targetid_){}
    , decltype(_impl_.damege_){}
...
inline void AttackArrowInfo::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
AttackArrowInfo::~AttackArrowInfo() {
  // @@protoc_insertion_point(destructor:Protocol.AttackArrowInfo)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void AttackArrowInfo::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}

void AttackArrowInfo::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void AttackArrowInfo::Clear() {
// @@protoc_insertion_point(message_clear_start:Protocol.AttackArrowInfo)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* AttackArrowInfo::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
...
uint8_t* AttackArrowInfo::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:Protocol.AttackArrowInfo)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Protocol.AttackArrowInfo)
  return target;
}

size_t AttackArrowInfo::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:Protocol.AttackArrowInfo)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData AttackArrowInfo::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    AttackArrowInfo::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*AttackArrowInfo::GetClassData() const { return &_class_data_; }


void AttackArrowInfo::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<AttackArrowInfo*>(&to_msg);
  auto& from = static_cast<const AttackArrowInfo&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:Protocol.AttackArrowInfo)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void AttackArrowInfo::CopyFrom(const AttackArrowInfo& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:Protocol.AttackArrowInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool AttackArrowInfo::IsInitialized() const {
  return true;
}

void AttackArrowInfo::InternalSwap(AttackArrowInfo* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
...
::PROTOBUF_NAMESPACE_ID::Metadata AttackArrowInfo::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_Struct_2eproto_getter, &descriptor_table_Struct_2eproto_once,
...
template<> PROTOBUF_NOINLINE ::Protocol::AttackArrowInfo*
Arena::CreateMaybeMessage< ::Protocol::AttackArrowInfo >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Protocol::AttackArrowInfo >(arena);
}
